...
namespace Dreamteck.Forever
{
    public class LevelPathGenerator : ScriptableObject
    {
        ...
        public void GeneratePath(LevelSegment inputSegment)
        {
            ...
            if (useCustomRule) customRule.OnPostGeneration(points);
        ...
        protected virtual void GeneratePoint(ref SplinePoint point, int pointIndex)
        {
            ...
            if (useCustomRule) customRule.OnGeneratePoint(point, lastPoint, pointIndex, controlPointsPerSegment);
        }
        ...
        protected void AutoTangents(ref SplinePoint[] points, int startIndex)
        {
        ...
        protected Vector3 ExtrapolatePoint(Vector3 p1, Vector3 p2, Vector3 p3)
        {
            Vector3 v1, v2;
            v1 = p2 - p1;
            v2 = p3 - p2;
