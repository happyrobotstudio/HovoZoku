namespace Dreamteck.Forever
{
    ...
    public partial class LevelSegment : MonoBehaviour
    {
        ...
        public class ObjectProperty
        {
            ...
            [SerializeField]
            [HideInInspector]
            private SegmentObjectSettings settingsComponent = null;
            ...
            public ExtrusionSettings extrusionSettings
            {
                get
                {
                    if (!overrideSettingsComponent && settingsComponent != null) return settingsComponent.settings;
                    return _extrusionSettings;
                }
            }
            ...
            public ObjectProperty(Transform t, bool isRoot = false)
            {
                ...
                GetReferences();
#if UNITY_EDITOR
                extrusionSettings.boundsInclusion = ForeverPrefs.extrudeBoundsInclusion;
                extrusionSettings.applyRotation = ForeverPrefs.extrudeApplyRotation;
                extrusionSettings.applyScale = ForeverPrefs.extrudeApplyScale;
                extrusionSettings.bendMesh = ForeverPrefs.extrudeBendSprite;
                extrusionSettings.bendSprite = ForeverPrefs.extrudeBendSprite;
                extrusionSettings.applyMeshColors = ForeverPrefs.extrudeApplyMeshColors;
                extrusionSettings.meshColliderHandling = ForeverPrefs.extrudeMeshColliderHandle;
#if DREAMTECK_SPLINES
                extrusionSettings.bendSpline = ForeverPrefs.extrudeExtrudeSpline;
#endif
#endif
            }
